...
const resources = {
  en: {
    translation: {
      ...
      theme: 'Theme',
      language: 'Language',
      whenClosingWindow: 'When closing the window',
      askOnFirstClose: 'Ask on first close',
      minimizeToTray: 'Minimize to tray',
      quitApplication: 'Quit application',
      closeBehaviorPromptTitle: 'What should happen when PortKill closes?',
      closeBehaviorPromptContent:
        'PortKill can keep running in the menu bar or system tray, or quit completely.',
      closeBehaviorRememberHint: 'Your choice will be saved and can be changed in Settings.',
      ...
      selectRequiredHint: 'Please select ports in the table first',
      activePortsDetail: 'Active Ports Detail',
      updates: 'Updates',
  ...
  zh: {
    translation: {
      ...
      theme: '主题',
      language: '语言',
      whenClosingWindow: '关闭窗口时',
      askOnFirstClose: '首次关闭时询问',
      minimizeToTray: '最小化到托盘',
      quitApplication: '彻底退出',
      closeBehaviorPromptTitle: '关闭 PortKill 时执行什么操作？',
      closeBehaviorPromptContent:
        '你可以让 PortKill 继续在菜单栏或系统托盘中运行，也可以彻底退出。',
      closeBehaviorRememberHint: '本次选择会被记住，之后可在设置中修改。',
      systemDefault: '跟随系统',
      light: '浅色',
      dark: '深色',
      ...
      clearSelection: '取消选择',
      selectRequiredHint: '请先在表格中勾选需要批量操作的端口',
      activePortsDetail: '已被占用端口明细',
      updates: '应用更新',
      currentVersion: '当前版本',
